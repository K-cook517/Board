...
import { createPost, getPosts, getPostById, updatePost } from '../api/boardApi'
...
// //게시물 삭제
// export const deletePostThunk = deleteAsyncThunk('posts/deletePost', async (postData, { rejectWithValue }) => {
//    try {
//    } catch (error) {
//       return rejectWithValue(error.response?.data?.message)
//    }
